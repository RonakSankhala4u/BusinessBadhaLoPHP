        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto text-center">
                    ...
                    <p class="lead">We help businesses grow with the help of our unique and innovative solutions. Our
                        team of experienced Business Consultants here at Business Badha Lo have practical knowledge of
                        all the fields. Whether you’re looking for specific advice or all-round assistance, we are here
                        to help you. We act as both – a digital marketing agency and business development company to
                        your business.</p>
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="card hover-bg-secondary shadow py-4">
                        <div class="card-body text-center">
                            ...
                            <h4 class="mb-4">FREE BUSINESS CONSULTING</h4>
                      ...
                      <div class="content">
                        <p>
                            <br>
                            Business Badha Lo. Com Provides You absloutly free consulting. Our small business consulting services help companies with tasks and goals. Simple pre-paid agreements are low-risk contracts to accomplish required objectives.Consultants help clients through analysis, statistics, and strategy. Clients partner with experienced consultants to plan critical steps for their small business. Through professionals operational improvements are outlined and implemented.</p>
                      </div>
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    <button class="collapsible">
                        ...
                        <div class="card-body text-center">
                            ...
                            <h4 class="mb-4">PRODUCT/SERVICE RESEARCHING</h4>
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="card hover-bg-secondary shadow py-4">
                        <div class="card-body text-center">
                            ...
                            <h4 class="mb-4">BUSINESS MODEL LAUNCHING</h4>
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="card hover-bg-secondary shadow py-4">
                        <div class="card-body text-center">
                            ...
                            <h4 class="mb-4">WEBSITE / APP DESIGNING</h4>
                ...
                <div class="col-xl-9 mx-auto">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7 offset-lg-1">
                            <div class="row">
                                <div class="col-12">
                                    <h2 class="text-white">Why Business Badha Lo ?</h2>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="text-white">Business Planing</h4>
                                            <p class="text-white">Business Badha Lo is a business development company
                                                with a team of experts with in-depth knowledge of business functions.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="text-white">Business performance and improvement</h4>
                                            <p class="text-white">We develop strategies for large brands to small and
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="text-white">Branding and Marketing</h4>
                                            <p class="text-white">Our Business Development Company will offer Business
                                                Development Services and Consultancy that will help you understand your
                                                audience and measure performance across all platforms to make
                                                data-informed decisions with confidence</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="text-white">Our Business Development Services, Methods and
                                                Strategies for businesses have proven success across different
                                                industries and at different growth stages.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-6 col-md-8 col-sm-7 col-8">
                    ...
                    <p class="text-light mb-4">Our mission is to be a true partner to you. We not only make your
                        business earn as much as possible but also save you as much time and money without neglecting
                        the quality.</p>
                    ...
                    <div class="col-md-6">
                        <div class="bg-white p-4">
                            ...
                            <form onsubmit="sendEmail(); reset(); return false;">
                                <input type="text" id="Name" class="form-control mb-4 px-0"
                                    placeholder="Full name">
                                <input type="text" id="Email"  class="form-control mb-4 px-0"
                                    placeholder="Email address">
                                <input type="tel" id="MobileNumber" class="form-control mb-4 px-0"
                                    placeholder="Mobile Number">

                                <textarea id="Message" class="form-control mb-4 px-0"
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 text-center text-md-left">
                        <p class="text-light mb-0">Copyright &copy; 2022 a Website by <a class="text-gradient-primary"
                                href="https://techsode.com">TechSode</a>
                        </p>
                    </div>
                    <div class="col-md-6">
